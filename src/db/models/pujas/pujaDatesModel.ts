...
export interface PujaDatesInput extends Optional<PujaDatesAttributes, 'sr_no' | 'created_by'> { }

// Define the output type for required fields
export interface PujaDatesOutput extends Required<PujaDatesAttributes> { }

class PujaDatesModel extends Model<PujaDatesAttributes, PujaDatesInput> implements PujaDatesAttributes {
  public sr_no!: number;
  ...
  public static associate() {
    PujaDatesModel.belongsTo(PujaModel, {
