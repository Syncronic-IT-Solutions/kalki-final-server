...
export interface AgentDetailsInput extends Optional<AgentDetailsAttributes, 'agent_id'> {}
export interface AgentDetailsOutput extends Required<AgentDetailsAttributes> {}

class AgentDetailsModel extends Model<AgentDetailsAttributes, AgentDetailsInput> implements AgentDetailsAttributes {
