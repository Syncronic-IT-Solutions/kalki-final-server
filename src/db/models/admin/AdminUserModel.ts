...
export interface AdminUsersInput extends Optional<AdminUsersAttributes, 'admin_user_id'> {}

// Define the output type for required fields
export interface AdminUsersOutput extends Required<AdminUsersAttributes> {}

class AdminUsersModel extends Model<AdminUsersAttributes, AdminUsersInput> implements AdminUsersAttributes {
