...
export interface TrackingInput extends Optional<TrackingAttributes, 'sr_no' | 'tracking_link'> {}

// Define the output type for required fields
export interface TrackingOutput extends Required<TrackingAttributes> {}

class TrackingModel extends Model<TrackingAttributes, TrackingInput> implements TrackingAttributes {
  public sr_no!: number;
