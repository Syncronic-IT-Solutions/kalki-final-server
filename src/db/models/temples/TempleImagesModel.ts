...
export interface TempleImagesInput extends Optional<TempleImagesAttributes, 'sr_no'> {}

// Define the output type for required fields
export interface TempleImagesOutput extends Required<TempleImagesAttributes> {}

class TempleImagesModel extends Model<TempleImagesAttributes, TempleImagesInput> implements TempleImagesAttributes {
  public sr_no!: number;
